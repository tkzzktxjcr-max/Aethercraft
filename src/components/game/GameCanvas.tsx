...
export const GameCanvas = () => {
  ...
  const { canvasOrbs, selectElement } = useGameStore();
  ...
  return (
    ...
    >
      ...
      {canvasOrbs.length === 0 && (
        <div data-canvas="true" className="absolute inset-0 flex items-center justify-center pointer-events-none">
          <div className="text-center">
            <p className="text-indigo-900/30 font-medium text-lg mb-2">Your canvas is empty</p>
